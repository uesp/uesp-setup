...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(wikidiff2)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(wikidiff2)
ZEND_DECLARE_MODULE_GLOBALS(wikidiff2)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(wikidiff2_globals_id, zend_wikidiff2_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(wikidiff2_globals_id, zend_wikidiff2_globals *, error_code )
#else
#define SWIG_ErrorMsg() (wikidiff2_globals.error_msg)
#define SWIG_ErrorCode() (wikidiff2_globals.error_code)
#endif

static void wikidiff2_init_globals(zend_wikidiff2_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void wikidiff2_destroy_globals(zend_wikidiff2_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_wikidiff2_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_wikidiff2_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_wikidiff2_do_diff) {
  ...
  result = (char *)wikidiff2_do_diff((char const *)arg1,(char const *)arg2,arg3);
...
static zend_function_entry wikidiff2_functions[] = {
 SWIG_ZEND_NAMED_FE(wikidiff2_do_diff,_wrap_wikidiff2_do_diff,NULL)
 SWIG_ZEND_NAMED_FE(swig_wikidiff2_alter_newobject,_wrap_swig_wikidiff2_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_wikidiff2_get_newobject,_wrap_swig_wikidiff2_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
zend_module_entry* SWIG_module_entry = &wikidiff2_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &wikidiff2_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(wikidiff2)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(wikidiff2, wikidiff2_init_globals, wikidiff2_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(wikidiff2_globals_id);
#endif
    return SUCCESS;
}
