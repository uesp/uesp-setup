...
/* Define to 1 if AIX OS level 5300-06 exists. */
...
/* Define to 1 if functions 'seteuid' and 'setegid' exists. */
...
/* Define to 1 if iODBC Driver Manager should be used. */
/* #undef HAVE_IODBC */
...
/* Define to 1 if function 'setpriority' exists. */
...
/* Define to 1 if struct 'vmtotal' exists. */
...
/* Define to 1 if UCD-SNMP should be enabled. */
/* #undef HAVE_UCDSNMP */
...
/* Define to 1 if struct 'uvmexp' exists. */
/* #undef HAVE_UVM_UVMEXP */

/* Define to 1 if struct 'uvmexp_sysctl' exists. */
/* #undef HAVE_UVM_UVMEXP2 */
